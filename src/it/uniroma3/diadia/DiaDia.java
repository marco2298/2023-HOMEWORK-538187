...
public class DiaDia {
	...
	public DiaDia(IO io,Labirinto labirinto) {
		...
		this.io = io;
		new FabbricaDiComandiFisarmonica(io);
	}
	...
	public void gioca() {
		...
		do		
			istruzione = this.io.leggiRiga();		//metodo che spezza il contenuto del digitato in righe e mettere il contenuto in una stringa
